...
function Home() {
    ...
    // We only use the FiltersPanel for API-level filtering if needed, 
    // but for now we can just fetch all and let the table handle it, 
    // or keep FiltersPanel as a pre-filter.
    // Given the user wants "Excel-style" filters on columns, client-side is best.
    // We'll pass the filters from panel to API, and let table handle the rest.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__854c0422._.js.map