...
"[project]/src/app/nifty100/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Nifty100Page() {
    ...
    const { data: stocks, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "stocks_nifty100",
            queryFilters
        ],
        queryFn: {
            "Nifty100Page.useQuery": async ()=>{
                const params = new URLSearchParams();
                Object.entries(queryFilters).forEach({
                    "Nifty100Page.useQuery": ([key, value])=>{
                        if (value !== undefined && value !== null && value !== "") {
                            params.append(key, String(value));
                        }
                    }
                }["Nifty100Page.useQuery"]);
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_URL}/stocks/nifty100`, {
                    params
                });
                return data;
            }
...
_s(Nifty100Page, "pPbQmjOBN9H+MBM6lNAlEUxJYqU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
_c = Nifty100Page;
var _c;
__turbopack_context__.k.register(_c, "Nifty100Page");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_22788842._.js.map