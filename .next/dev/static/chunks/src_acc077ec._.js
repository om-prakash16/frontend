...
function StocksIndex() {
    _s();
    const { data: stocks, isLoading, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useStocks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStocks"])({});
    const [search, setSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const filteredStocks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StocksIndex.useMemo[filteredStocks]": ()=>{
            let result = stocks || [];
            // 1. Search
            if (search) {
                const q = search.toLowerCase();
                result = result.filter({
                    "StocksIndex.useMemo[filteredStocks]": (s)=>s.symbol.toLowerCase().includes(q) || s.name?.toLowerCase().includes(q)
                }["StocksIndex.useMemo[filteredStocks]"]);
            }
            // 2. Filters
...
_s(StocksIndex, "0nuBsE9O9nJjK21qb+VEmoVbvJo=", false, function() {
    return [
...
_c = StocksIndex;
var _c;
__turbopack_context__.k.register(_c, "StocksIndex");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_acc077ec._.js.map